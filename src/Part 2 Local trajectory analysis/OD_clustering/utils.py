...
def OD_compute(traj, max_dist, min_dist, hour):
    aggregator = mpd.TrajectoryCollectionAggregator(traj, max_distance=max_dist, min_distance=min_dist,min_stop_duration=timedelta(hours=hour))
