...
36 } , { ( char_T * ) ( & rtDW . dpjztba1yh ) , 0 , 0 , 34 } , { ( char_T * )
( & rtDW . ghkckquryd . AQHandles ) , 11 , 0 , 15 } , { ( char_T * ) ( & rtDW
. cnawslddci ) , 6 , 0 , 3 } , { ( char_T * ) ( & rtDW . h5x2psv2rm ) , 10 ,
0 , 1 } , { ( char_T * ) ( & rtDW . drikfmio3n ) , 8 , 0 , 9 } } ; static
DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
LOSobserver_K_f ) , 0 , 0 , 54 } } ; static DataTypeTransitionTable
